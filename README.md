...
CD is prepared as a manual GitHub Actions workflow that deploys to the team server over SSH. Server secrets must be configured before running deployment. See [docs/ci-cd.md] for the full setup and required GitHub secrets.
